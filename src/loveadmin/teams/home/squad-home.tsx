...
type SquadHomeProps = {
  ...
  getCoachesForSquad: (squad: Squad) => Coach[];
  getTotalPlayersCount: (squad: Squad) => number;
  setActiveTab?: (tabName: string) => void;
};

const SquadHome: React.FC<SquadHomeProps> = ({
  selectedSquad,
  getCoachesForSquad,
  ...
  return (
    <div className="grid auto-rows-[9rem] grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <HomeWidget
        ...
        icon={
          <svg
            ...
            fill="none"
            viewBox="0 0 24 24"
            className="w-12 h-12 -mb-1.5 -mr-2 text-primary-300"
          >
            <path
              stroke="currentColor"
              strokeLinecap="round"
      ...
      <HomeWidget
        ...
        value={selectedSquad && getTotalPlayersCount(selectedSquad)}
        icon={
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            ...
            fill="none"
            viewBox="0 0 24 24"
            className={`w-10 h-10 -mr-2 text-primary-300`}
          >
            <path
              stroke="currentColor"
              strokeLinecap="round"
      ...
      <HomeWidget
        ...
        value={
          selectedSquad && (
            <>
              {getCoachesForSquad(selectedSquad)
                .slice(0, 4)
              ...
              {selectedSquad &&
                getCoachesForSquad(selectedSquad).length > 4 && (
                  <span className="inline">
                    {" "}
                    + {getCoachesForSquad(selectedSquad).length - 4} more.
                  </span>
                )}
            </>
          )
        ...
        extra={
          <>
            ...
            {selectedSquad && getCoachesForSquad(selectedSquad).length > 4 && (
              <div className="shrink-0">
                <div className="flex items-center justify-center w-8 h-8 text-xs rounded-full text-primary-500 bg-primary-50 ring-2 ring-white">
                  <span>+{getCoachesForSquad(selectedSquad).length - 4}</span>
                </div>
              </div>
            )}
          </>
      ...
      <button
        type="button"
        className="col-span-1 row-span-1 p-5 text-left border rounded-lg shadow-sm group bg-primary-500 border-black/10"
      >
        <div className="relative flex flex-col justify-between h-full">
          ...
          <div className="-ml-2 -mb-1.5 flex items-center">
            ...
            <svg
              ...
              fill="none"
              viewBox="0 0 24 24"
              className="-ml-3 w-7 h-7 -mt-0.5 text-primary-200"
            >
              <path
                stroke="currentColor"
                strokeLinecap="round"
        ...
        <div className="relative flex flex-col justify-between h-full">
          ...
          <div className="-ml-2 -mb-1.5 flex items-center">
            ...
            <svg
              ...
              fill="none"
              viewBox="0 0 24 24"
              className="-ml-2.5 w-7 h-7 -mt-0.5 text-primary-200"
            >
              <path
                stroke="currentColor"
                strokeLinecap="round"
